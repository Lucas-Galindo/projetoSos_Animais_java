...
import sosanimais.com.example.app.controller.services.AnimalService;
import sosanimais.com.example.app.model.Erro;
...
public class AnimalController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateAnimal(@PathVariable int id, @RequestBody Animal animal){
        animal.setId(id);
